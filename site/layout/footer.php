            ...
            <div class="modal-content">
                ...
                <form action="?c=customer&a=register" method="POST" role="form" class="form-register">
                    <div class="modal-body">
                        ...
                        <div class="form-group g-recaptcha" data-sitekey="6LfJMB4iAAAAAPRwyADlfOxG4OGHKh4dZ3refJpy">
                        </div>
                        <input type="text" style="opacity:0;width:1px;height:1px;border:none;padding:0" name="hiddenRecaptcha">
    ...
    <div class="modal fade" id="modal-login" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="?c=auth&a=login" method="POST" role="form">
                    <div class="modal-body">
                        <div class="form-group">
